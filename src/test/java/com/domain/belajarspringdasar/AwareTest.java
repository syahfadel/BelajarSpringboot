...
import com.domain.belajarspringdasar.service.AuthService;
...
public class AwareTest {
    ...
    void testAware() {
        ...
        Assertions.assertEquals("com.domain.belajarspringdasar.service.AuthService", authService.getBeanName());
